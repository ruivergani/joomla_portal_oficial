...
<!-- alteração tamanho da fonte - fim -->
                ...
                <div class="row-fluid">
                    <div id="logo" class="span8<?php if($this->params->get('classe_nome_principal', '') != '') echo ' '.$this->params->get('classe_nome_principal'); ?>">
                        <a href="<?php echo JURI::root(); ?>" title="<?php echo $this->params->get('nome_principal', 'Nome principal'); ?>">
                            ...
                            <img class="visible-desktop" src="<?php echo JURI::root(); ?><?php echo $this->params->get('emblema', ''); ?>" alt="<?php echo $this->params->get('nome_principal', 'Nome principal'); ?>" />
                            <?php endif; ?>
                ...
                <div class="row-fluid">
                    ...
                    <div id="navigation" class="span3">
                        ...
                        <section id="navigation-section">
                            ...
                            <div class="span8 small visible-desktop" id="logo_vertical">
                                <p>
                                <a href="index.php">
                                <img src="images/logo-vertical.png" class="logo-vert" alt="logo vertical" style="margin: auto !important; float: none; margin-left: 13px !important;"></a>
                                </p>
                            </div>
        ...
        <footer>
            ...
            <div class="footer-ferramenta">
                <div class="container" ">
                    <?php echo $this->params->get('mensagem_final_ferramenta', '<p style="line-height: 15px;">Desenvolvido com o CMS de c&oacute;digo aberto <a href="http://www.joomla.org">Joomla</a> | Por Herbert Faria Pinto e Rui Vergani Neto</p>'); ?>
                </div>
            </div>
